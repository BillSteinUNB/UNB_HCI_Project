...
export interface Room { id: string; number: string; type: string; floor: string; capacity: number; professor?: string; features: string[]; schedule: ScheduleItem[]; currentStatus?: 'available' | 'busy'; }
